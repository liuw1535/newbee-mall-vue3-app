  ...
  <div @click="checkLogin">
    <header class="home-header wrap" :class="{'active' : state.headerScroll}">
      ...
      <div class="header-search">
        ...
        <router-link tag="span" class="search-title" to="./product-list?from=home">这，就是华东交大！</router-link>
      </div>
...
const checkLogin = (e) => {
  ...
  if (e.target.closest('.van-tabbar')) return; // 排除底部导航
  showToast('还未登录哦~，登录解锁更多功能');
